...
import qualified ECC.Code.LDPC.Reference.Sparse as SparseReference
import qualified ECC.Code.LDPC.Model as Model

import qualified ECC.Code.LDPC.ElimTanh as ElimTanh

codes :: Code
codes = Unencoded.code <> OrigReference.code <> SparseReference.code <> Model.code <> ElimTanh.code
